...
rectangles = getCornersOfImages((286,32,316))
print(rectangles)
coor_system.set_rectangles(rectangles)
num = coor_system.get_indecies_on_rotate(286,32,316)

st = ImageStitcher(img1,img2,False)
st.drawImage(286,32,360-316,0)
st.set_canvas()
print(st.calculateLoss((286,32,316)))
